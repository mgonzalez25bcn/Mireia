...
formularioReserva.addEventListener('submit', (e)=>{
  e.preventDefault()  //interrumpe el flujo natural del evento, en este caso del submit
...
document.addEventListener('keydown', (e)=>{
  // console.log(e.key)  //podemos escribir en la consola, o ver qué escribe con cada tecla que pulsamos
  if(e.key === 'Escape'){
